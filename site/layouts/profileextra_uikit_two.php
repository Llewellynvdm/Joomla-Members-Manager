...
<?php if ($displayData->setCharts): ?>
	<?php foreach ($displayData->charts as $name => $codes): ?>
		<?php foreach ($codes as $code): ?>
			<a href="#getreport" onclick="loadTheChartInModal(<?php echo $code['function_name']; ?>, '<?php echo $code['id_name']; ?>')" class="uk-thumbnail uk-thumbnail-small <?php echo $code['id_name']; ?>_target" data-uk-modal><?php echo $code['div']; ?></a>
		<?php endforeach; ?>
	<?php endforeach; ?>
<?php else: ?>
