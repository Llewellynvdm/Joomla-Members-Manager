...
class MembersmanagerController extends JControllerLegacy
{
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		{
			if ($data['edit'] && $layout == 'edit' && !$this->checkEditId('com_membersmanager.edit.'.$data['view'], $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_membersmanager&view='.$data['views'], false));
				}
