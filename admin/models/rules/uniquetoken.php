...
/**
 * Form Rule (Uniquetoken) class for the Joomla Platform.
 */
class JFormRuleUniquetoken extends FormRule
{
	/**
	...
	public function test(\SimpleXMLElement $element, $value, $group = null, Registry $input = null, Form $form = null)
	{
		...
		if (strlen($value) && strlen($table) > 3 && strpos($table, 'membersmanager.') !== false)
		{
