...
<tr>
	...
	<?php endif; ?>
	<th class="nowrap" >
			<?php echo JHtml::_('grid.sort', 'COM_MEMBERSMANAGER_TYPE_NAME_LABEL', 'name', $this->listDirn, $this->listOrder); ?>
	</th>
	...
	<?php else: ?>
		<th width="10" class="nowrap center" >
			<?php echo JText::_('COM_MEMBERSMANAGER_TYPE_STATUS'); ?>
		</th>
	<?php endif; ?>
	<th width="5" class="nowrap center hidden-phone" >
			<?php echo JHtml::_('grid.sort', 'COM_MEMBERSMANAGER_TYPE_ID', 'id', $this->listDirn, $this->listOrder); ?>
	</th>
</tr>