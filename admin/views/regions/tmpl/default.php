...
<form action="<?php echo JRoute::_('index.php?option=com_membersmanager&view=regions'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
        ...
        <?php if ($this->canCreate && $this->canEdit) : ?>
            <?php echo JHtml::_(
                ...
                'collapseModal',
                array(
                    'title' => JText::_('COM_MEMBERSMANAGER_REGIONS_BATCH_OPTIONS'),
