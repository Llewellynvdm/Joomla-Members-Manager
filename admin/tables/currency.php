 ...
 */
class MembersmanagerTableCurrency extends JTable
{
	/**
	...
	{
		parent::__construct('#__membersmanager_currency', 'id', $db); 
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_MEMBERSMANAGER_CURRENCY_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_membersmanager.currency.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_membersmanager.currency.'.(int) $this->$k;
	}
