...
class MembersmanagerTableType extends JTable
{
	...
	/**
	 * Overload the store method for the Type table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New type. A type created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_MEMBERSMANAGER_TYPE_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_membersmanager.type.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_membersmanager.type.'.(int) $this->$k;
	}
